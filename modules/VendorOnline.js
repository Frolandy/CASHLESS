var CommGlolime = function CommGlolime(config) {
...
CommGlolime.prototype.ReadLimit = function(strCardUid) {
  var cardType = 0;
...
CommGlolime.prototype.SavePurchase = function(strId, strPrice, strUserId) {
